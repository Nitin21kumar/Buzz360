                ...
                {voices.map((v) => (
                  <div key={v._id} style={styles.voiceRow}>
                    ...
                    <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                      <SecureAudio loadUrl={() => api.getTtsAudioBlobUrl(folder.id, v.filename)} style={{ height: 30, width: 150 }} />
                      <SecureDownloadButton loadUrl={() => api.getTtsAudioBlobUrl(folder.id, v.filename)} filename={v.filename}>
