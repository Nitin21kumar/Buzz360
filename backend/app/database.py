...
_names=["tts_audio","voice_folders","stt_history","campaigns","contacts","call_logs","users","whatsapp_campaigns","whatsapp_contacts","whatsapp_messages","whatsapp_conversations","whatsapp_keyword_rules","whatsapp_settings"]
